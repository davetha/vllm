...
class CompressedTensorsWNA16MoEMethod(CompressedTensorsMoEMethod):
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        # ROCm int4 only: further repack to N-packed int32 [E, K, N//8] for
        # tl.interleave unpacking in the Triton kernel.
        #
        # Upstream vllm-project/vllm#43389 restricts this to on_gfx1x() (RDNA).
        # Widened to GFX9 here after measuring it on 2x MI210 (gfx90a): output
        # is bit-identical to the scalar-shift path and the MoE int4 kernel is
        # 1.45x-4.8x faster (rocprofv3, median of 160 launches, M=1..128, both
        # fp16 and bf16). See docs/ for the measurement.
